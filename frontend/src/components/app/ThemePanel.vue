			...
			<div class="app-theme-panel-container">
				...
				<div class="app-theme-panel-content">
					...
					<card class="card mb-3">
						<card-body class="p-2">
							<div class="row gx-2">
								<div class="col-6" v-for="direction in directionList">
									<a href="javascript:;" 
										v-bind:class="{ 'active': (direction.value === 'rtl' && appOption.appRtlMode) || (direction.value === 'ltr' && !appOption.appRtlMode) }"
										v-on:click="(event) => toggleRtlMode(event, direction.value)"
										class="btn btn-sm btn-outline-light d-flex align-items-center justify-content-center gap-2 w-100 rounded-0 fw-bold fs-12px">
										<i class="bi bi-text-left fs-16px my-n1 ms-n2"></i> {{direction.name}}
									</a>
								</div>
							</div>
						</card-body>
