			...
			<div class="menu-item dropdown dropdown-mobile-full">
				<a href="#" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link">
					<div class="menu-img online">
						<img v-if="auth.user?.avatar" :src="auth.user.avatar" alt="avatar" class="rounded-circle w-100 h-100" style="object-fit:cover" />
				...
				<div class="dropdown-menu dropdown-menu-end me-lg-3 fs-11px mt-1">
					...
					<a href="#" class="dropdown-item d-flex align-items-center" v-on:click.prevent="logout">LOGOUT <i class="bi bi-toggle-off ms-auto text-theme fs-16px my-n1"></i></a>
				</div>
			</div>
		</div>
		<!-- END menu -->
